...
import HeaderLastMenu from '../Basic-components/HeaderLastMenu';
  ...
  return (
    <React.Fragment>
      <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
        <Tooltip title="Account settings">
          <IconButton onClick={handleClick} size="small" sx={{ ml: 2 }}>
              <p className='my-menu-button'  color="textPrimary">{userInfo.firstName}</p>
          </IconButton>
        </Tooltip>
        <HeaderLastMenu />
      ...
      >
        ...
        <Divider />
        <MenuItem onClick={myOrdersHandler}>
          <ListItemIcon>
